                                  ...
                                  trailing: Consumer<UserProfileProvider>(
                                    builder: (context, profile, _) => Switch(
                                      ...
                                      onChanged: (v) async {
                                        ...
                                        if (v) {
                                          try {
                                            final granted = await PushService
                                                .instance
                                                .requestPermission();
                                            if (!granted) {
                                            ...
                                            final registered = await PushService
                                                .instance
                            ...
                            child: Column(
                              children: [
                                ...
                                ListTile(
                                  ...
                                  onTap: () async {
                                    final url = Uri.parse(
                                        'https://www.facebook.com/groups/floatit.itucph/');
