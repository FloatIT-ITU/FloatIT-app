...
class FirebaseService {
  ...
  static CollectionReference get users => _instance.collection(FirestoreConstants.users);
  
  /// Reference to the public_users collection
  static CollectionReference get publicUsers => _instance.collection(FirestoreConstants.publicUsers);
  
  /// Reference to the events collection
  static CollectionReference get events => _instance.collection(FirestoreConstants.events);
  
  /// Reference to the app collection
  static CollectionReference get app => _instance.collection(FirestoreConstants.app);
  
  /// Reference to the templates collection
  static CollectionReference get templates => _instance.collection(FirestoreConstants.templates);
  ...
  static DocumentReference get globalBanner => app.doc(FirestoreConstants.globalBanner);
  
  /// Get an event banner document
  static DocumentReference eventBanner(String eventId) => 
      eventDoc(eventId).collection(FirestoreConstants.meta).doc(FirestoreConstants.eventBanner);
  ...
  static Query get adminUsersQuery => users.where(FirestoreConstants.admin, isEqualTo: true);
  
  /// Stream of admin users
  static Stream<QuerySnapshot> get adminUsersStream => adminUsersQuery.snapshots();
